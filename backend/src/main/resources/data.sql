...
-- Drop dependent tables first (avoid FK violations)
...
-- ==========================================================
-- 👤 USERS, ROLES & PERMISSIONS (for Login)
-- ==========================================================
INSERT INTO roles (id, name) VALUES (1, 'ROLE_ADMIN');

-- bcrypt for "admin123"
INSERT INTO users (id, username, email, password) VALUES
(1, 'admin', 'admin@edata4you.com', '$2a$10$hXKcVtEcgT2UuRzEpHybwOXqfUl47Fv8eQH2g1r0Jj3c3OEbqHEua');
